      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8 justify-items-center md:justify-items-start text-center md:text-left">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <Link href="/" className="text-lg sm:text-xl font-bold text-text-primary hover:text-accent transition-colors inline-block">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-text-primary mb-2 sm:mb-3 text-sm sm:text-base">{t('footer.quickLinks')}</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-text-primary mb-2 sm:mb-3 text-sm sm:text-base">{t('footer.contactTitle')}</h4>
        ...
        <div className="border-t border-border-primary pt-6 sm:pt-8">
          <div className="text-center text-xs sm:text-sm text-neutral">
            <p>&copy; {new Date().getFullYear()} <span className="text-accent">Chiko</span>x. {t('footer.rights')}</p>
          </div>
        </div>
      </div>
    </footer>
