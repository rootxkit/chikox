    ...
    <div className="min-h-screen flex flex-col">
      ...
      <Section paddingVariant="large" horizontalPadding>
        <div className="max-w-lg text-center mx-auto">
          <p className="mb-3 font-semibold md:mb-4 text-neutral">About Us</p>
          ...
          <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
            <button className="inline-flex items-center justify-center whitespace-nowrap bg-accent text-text-alternative px-6 py-3 hover:bg-accent-hover transition-colors">
              Get Started
            </button>
            <button className="inline-flex items-center justify-center whitespace-nowrap border border-border-primary bg-background-alternative text-text-primary px-6 py-3 hover:bg-background-secondary transition-colors">
              Learn More
            </button>
          </div>
        </div>
      ...
      <Section paddingVariant="large" horizontalPadding background="secondary">
        <div className="max-w-lg text-center mx-auto">
          <div className="flex flex-col items-center justify-start">
            ...
            <p className="mb-3 font-semibold md:mb-4 text-neutral">Our Mission</p>
            ...
            <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
              <button className="inline-flex items-center justify-center whitespace-nowrap border border-border-primary bg-background-alternative text-text-primary px-6 py-3 hover:bg-background-primary transition-colors">
                Learn More
              </button>
              <button className="inline-flex items-center justify-center whitespace-nowrap border-0 text-accent gap-2 p-0 hover:gap-3 hover:text-accent-hover transition-all">
                Contact Us
                <svg
                  stroke="currentColor"
                  fill="none"
      ...
      <Section paddingVariant="large" horizontalPadding>
        <div className="mb-12 max-w-lg md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4 text-neutral">Our Team</p>
          <h2 className="mb-5 text-2xl font-bold sm:text-3xl md:mb-6 md:text-4xl lg:text-5xl">
            Meet our team
          </h2>
          <p className="md:text-md text-neutral">
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="flex flex-col items-start">
              ...
              <div className="mb-3 md:mb-4">
                ...
                <h6 className="md:text-md text-neutral">{member.role}</h6>
              </div>
      ...
      {/* Trusted By Section */}
      <Section paddingVariant="default" horizontalPadding background="secondary">
        ...
        <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
          {logos.map((logo, index) => (
            <div
              key={index}
              className="flex w-full items-start justify-center justify-self-center bg-background-alternative px-4 pb-4 pt-[0.875rem] md:p-[0.875rem]"
            >
              <Image
                src={logo.src}
      ...
      <Section paddingVariant="large" horizontalPadding>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8 hover:border-accent transition-colors"
            >
              <div className="mb-5 md:mb-6 w-full">
                ...
                <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                  ...
                  <div>
                    ...
                    <p className="text-neutral">{testimonial.position}</p>
                  </div>
                </div>
              </div>
              <div className="mt-6 md:mt-8">
